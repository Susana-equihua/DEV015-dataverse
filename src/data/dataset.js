export default [
  ...
  },
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/pascal-image.png",
    facts: {
      species: "Camaleón",
    ...
    extraInfo: {
      curiousFact:
        "Pascal está basado en el camaleón mascota de una de las animadoras de Disney.",
    },
  },
  {
    id: "abu",
    name: "Abu",
    shortDescription:
      'De "Aladdín", es el mono travieso y leal compañero de Aladdín, con habilidades para el robo y la aventura.',
    description:
    ...
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/abu-image.png",
    facts: {
      species: "Mono (Macaco)",
      speciesGroup: "Pequeñas especies",
      gender: "Macho",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        "Walt Disney estaba tan encantado con Figaro que decidió hacerlo la mascota de Minnie Mouse.",
    },
  },
  {
    id: "sven",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        'Una de las frases más icónicas de Marie es: "Porque soy una dama, por eso".',
    },
  },
  {
    id: "flounder",
    ...
    extraInfo: {
      curiousFact:
        "Flounder, a pesar de su nombre (traducido del inglés), no es un lenguado sino un pez tropical ficticio.",
    },
  },
  {
    id: "duquesa",
    ...
    extraInfo: {
      curiousFact:
        "Su nombre refleja a una gata de alta sociedad en la romántica y culturalmente rica ciudad de París.",
    },
  },
  {
    id: "rajah",
    name: "Rajah",
    shortDescription:
      'De "Aladdín", es el tigre guardián y fiel amigo de la princesa Jasmín, feroz pero cariñoso.',
    description:
      'Rajah es el majestuoso tigre de la Princesa Jasmine en la película "Aladdín". Con su pelaje anaranjado y rayas negras, Rajah es una presencia imponente en el palacio de Agrabah. Su personalidad se destaca por su lealtad inquebrantable hacia su dueña y su desconfianza hacia los extraños, especialmente hacia los pretendientes no deseados que intentan cortejar a Jasmine. Una escena divertida en la película es cuando Rajah confronta a Aladdin disfrazado como "Príncipe Ali", dejando en claro con su actitud y gruñidos que no se dejará engañar fácilmente. A pesar de su apariencia feroz, es cariñoso y leal.',
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/rajah-image.png",
    facts: {
    ...
    extraInfo: {
      curiousFact:
        "Rajah fue un regalo del Sultán a Jasmín, y es tan protector que incluso asusta a los pretendientes indeseados.",
    },
  },
  {
    id: "meeko",
    ...
    extraInfo: {
      curiousFact:
        "Meeko tiene una debilidad por las galletas y siempre busca la manera de conseguir más.",
    },
  },
  {
    id: "tambor",
    name: "Tambor",
    shortDescription:
      'De "Bambi", es el conejo alegre, parlanchín y mejor amigo de Bambi, siempre le está dando buenos consejos.',
    description:
      'Tambor es el divertido conejo amigo de Bambi en la película "Bambi". Con su pelaje gris y blanco, Tambor es conocido por su hábito de golpear el suelo con su pata trasera. Vive en el bosque y ayuda a Bambi a aprender sobre su entorno y hacer nuevos amigos. En una escena, Tambor intenta enseñarle a Bambi cómo "marchar" como un verdadero ciervo, con movimientos exagerados y expresiones graciosas, mostrando su entusiasmo y paciencia a la vez. Es alegre, parlanchín y siempre tiene un buen consejo para Bambi.',
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/tambor-image.png",
    facts: {
      species: "Conejo",
      speciesGroup: "Animales Salvajes",
      gender: "Macho",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        "Dante es un Xoloitzcuintle, una raza antigua de perro mexicana.",
    },
  },
  {
    id: "sebastian",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        "Sus sonidos fueron creados por el actor de voz Frank Welker, mismo que ha dado vida a Scooby-Doo y el gato Garfield.",
    },
  },
  {
    id: "terk",
    name: "Terk",
    shortDescription:
      'De "Tarzán", es la gorila y mejor amiga de Tarzán, fuerte, traviesa y siempre dispuesta a una aventura.',
    description:
    ...
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/terk-image.png",
    facts: {
      species: "Gorila",
      speciesGroup: "Animales Salvajes",
      gender: "Hembra",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        "Pongo y Perdita tienen en total 101 cachorros, incluyendo a los adoptados, haciendo honor al título de la película.",
    },
  },
  {
    id: "nana",
  ...
  },
  {
    ...
    extraInfo: {
      curiousFact:
        "La escena del espagueti es una de las más icónicas del cine animado y ha sido parodiada en numerosas ocasiones.",
    },
  },
  {
    id: "rufus",
    ...
    extraInfo: {
      curiousFact:
        "Rufus es uno de los pocos personajes de Disney que aparece con una edad avanzada desde el principio.",
    },
  },
  {
    id: "bolt",
    ...
    imageUrl:
      "https://raw.githubusercontent.com/Susana-equihua/DEV015-dataverse/main/Disney%20pets/bolt-image.png",
    facts: {
    ...
    extraInfo: {
      curiousFact:
        "Bolt fue animado utilizando una combinación de técnicas de animación por computadora y animación tradicional.",
    },
  },
  {
    id: "heihei",
    ...
    extraInfo: {
      curiousFact:
        "HeiHei fue originalmente concebido como un personaje inteligente y astuto, pero se cambió para ser cómico y despistado.",
    },
  },
  {
    id: "bruno",
